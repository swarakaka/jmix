...
import io.jmix.flowui.component.pagination.PaginationCollectionLoader;
import io.jmix.flowui.component.pagination.PaginationLoader;
                ...
                .ifPresent(id -> {
                    ...
                    if (loader instanceof BaseCollectionLoader) {
                        PaginationLoader paginationLoader =
                                applicationContext.getBean(PaginationCollectionLoader.class, loader);
                        resultComponent.setPaginationLoader(paginationLoader);
                    } else {
                        throw new GuiDevelopmentException(
                                String.format("PaginationLoader does not support %s loader type",
